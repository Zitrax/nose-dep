...
class TestDecoratedDirectory(NoseDepPluginTester):
    suitepath = "test_scripts/dir_test:"

    def runTest(self):
        self.check(['test_04 (dir_tests.display_node_list) ... ok',
                    'test_03 (dir_tests.display_node_list) ... ok',
                    'test_02 (dir_tests.display_node_list) ... ok',
                    'test_01 (dir_tests.display_node_list) ... ok'])


class TestDecoratedDirectoryDirect(NoseDepPluginTester):
    suitepath = "test_scripts/dir_test:dir_tests.py:"
